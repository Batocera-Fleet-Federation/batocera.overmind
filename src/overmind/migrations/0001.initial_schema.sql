...
DROP TABLE IF EXISTS notification_fields CASCADE;
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS drone_peer_checks CASCADE;
DROP TABLE IF EXISTS drone_event_fields CASCADE;
DROP TABLE IF EXISTS drone_events CASCADE;
DROP TABLE IF EXISTS drone_speed_samples CASCADE;
DROP TABLE IF EXISTS drone_emulator_config_versions CASCADE;
DROP TABLE IF EXISTS drone_emulator_configs CASCADE;
DROP TABLE IF EXISTS drone_log_files CASCADE;
DROP TABLE IF EXISTS drone_log_sources CASCADE;
DROP TABLE IF EXISTS gameplay_sessions CASCADE;
DROP TABLE IF EXISTS sync_activity CASCADE;
DROP TABLE IF EXISTS download_items CASCADE;
DROP TABLE IF EXISTS download_snapshots CASCADE;
DROP TABLE IF EXISTS drone_action_result_fields CASCADE;
DROP TABLE IF EXISTS drone_action_result_records CASCADE;
DROP TABLE IF EXISTS drone_action_parameters CASCADE;
DROP TABLE IF EXISTS drone_actions CASCADE;
DROP TABLE IF EXISTS drone_artwork CASCADE;
DROP TABLE IF EXISTS drone_bios CASCADE;
DROP TABLE IF EXISTS drone_roms CASCADE;
DROP TABLE IF EXISTS asset_inventory_batches CASCADE;
DROP TABLE IF EXISTS systems CASCADE;
DROP TABLE IF EXISTS pending_drone_connections CASCADE;
DROP TABLE IF EXISTS approved_drone_tokens CASCADE;
DROP TABLE IF EXISTS integration_tokens CASCADE;
DROP TABLE IF EXISTS device_admin_claims CASCADE;
DROP TABLE IF EXISTS drone_auto_sync_policy_systems CASCADE;
DROP TABLE IF EXISTS drone_auto_sync_policies CASCADE;
DROP TABLE IF EXISTS drone_certificate_sans CASCADE;
DROP TABLE IF EXISTS drone_certificates CASCADE;
DROP TABLE IF EXISTS drone_performance_metrics CASCADE;
DROP TABLE IF EXISTS drone_system_info CASCADE;
DROP TABLE IF EXISTS drone_network_addresses CASCADE;
DROP TABLE IF EXISTS drone_network_state CASCADE;
DROP TABLE IF EXISTS drones CASCADE;
DROP TABLE IF EXISTS swarm_invitations CASCADE;
DROP TABLE IF EXISTS swarm_memberships CASCADE;
DROP TABLE IF EXISTS swarms CASCADE;
DROP TABLE IF EXISTS password_resets CASCADE;
DROP TABLE IF EXISTS email_verifications CASCADE;
DROP TABLE IF EXISTS user_notification_type_settings CASCADE;
DROP TABLE IF EXISTS user_notification_settings CASCADE;
DROP TABLE IF EXISTS user_fleet_settings CASCADE;
DROP TABLE IF EXISTS user_auth_identities CASCADE;
DROP TABLE IF EXISTS user_profiles CASCADE;
DROP TABLE IF EXISTS users CASCADE;
DROP TABLE IF EXISTS overmind_device_asset_staging CASCADE;
DROP TABLE IF EXISTS overmind_device_assets CASCADE;
DROP TABLE IF EXISTS overmind_app_state CASCADE;
DROP TABLE IF EXISTS drone_action_results CASCADE;
DROP TABLE IF EXISTS overmind_schema_versions CASCADE;
